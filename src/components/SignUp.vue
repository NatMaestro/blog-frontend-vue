<template>
    <div class="login-container">
      <h2 class="text-3xl mb-8 font-bold">Sign Up</h2>
      <form @submit.prevent="signup">
        ...
        <p class="mt-5">Already have an account? <><span class="text-blue-600 ml-3"><router-link to="/login" >Sign in</router-link></span></p>
    ...
    methods: {
        async signup() {
            try {
                ...
                this.$router.push('/login'); // Redirect to home or dashboard
            } catch (error) {
